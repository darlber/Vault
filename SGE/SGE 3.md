...
La conexión a PostgreSQL en PgAdmin necesita IP/servidor, puerto (5432), base de datos inicial, usuario y contraseña.  
...
En Odoo, al instalar el perfil mínimo, hay que asegurarse de que existen o introducir los datos esenciales: Títulos (Empresa/Contacto), Funciones (cargos) y Provincias.  
