...
- No se conserva ninguna guitarra medieval, y la información es escasa y a veces contradictoria. Pajares Alonso[^3] sitúa la guitarra en el contexto más amplio de la historia de la música, mientras que Radole[^4] ofrece una visión general del laúd, la guitarra y la vihuela como instrumentos de la misma familia.
...
- La historia de la guitarra en este período ha sido documentada por Boyd y Carreras[^10] e Iborra[^11], quienes analizan la evolución social y organológica del instrumento.
...
- Durante los **siglos XVII y XVIII**, la **guitarra de cinco órdenes** alcanzó gran desarrollo:
  - Se publicaron **más de 150 libros** impresos[^13] para este instrumento, según documenta Ophee[^13] en su estudio sobre los métodos de guitarra.
...
- En **1799**, además de Fernando Moretti[^11], **otros autores publicaron métodos** para la nueva guitarra de seis órdenes:
...
- **Únicamente dos publicaciones** dedicadas a la guitarra renacentista de **cuatro órdenes**:
  1. **1546** – *Tres libros de música en cifra para vihuela* (Alonso Mudarra[^3]):
...
1. Alonso Mudarra[^3] – *Tres libros de música en cifra para vihuela* (Sevilla, 1546)
2. Melchiore de Barberiis – *Opera intitolata Confina* (Venecia, 1549)
3. Simon Gorlier[^17] – *Le troysieme livre... de guitente* (París, 1551)
4. Adrian le Roy[^19] – *Premier livre de tabulature de guiterre* (París, 1551)
5. Adrian le Roy[^19] – *Tiers livre de tabulature de guiterre* (París, 1552)
6. Guillaume Morlaye – *Le premier livre... de guitente* (París, 1552)
7. Guillaume Morlaye – *Quatruiesme livre... de guyterne* (París, 1552)
8. Gregoire Brayssing – *Quan livre de tabulature de guiterre* (París, 1553)
9. Guillaume Morlaye – *Le second livre... de guiterre* (París, 1553)
10. Miguel de Fuenllana[^14] – *Libro de música para vihuela intitulado Orphenica Lyra* (Sevilla, 1554)
11. Adrian le Roy[^19] – *Cinquiesme livre de guiterre* (París, 1554)
12. Adrian le Roy[^19] – *Second livre de guiterre* (París, 1556)
13. Pierre Phalese[^20] y Jean Bellere – *Selectissima elegantissimaque...* (Lovaina y Amberes, 1570)
...
==Sobre la lectura debemos decir que lo recomendable es que el intérprete no utilice ningún tipo de transcripción, ya que hoy en día tenemos los facsímiles y además no es complicado leer una tablatura antigua. Esto ya lo defienden J. Tyler[^27] y G. Arriaga[^28], y el propio Turnbull[^29] aboga por el uso de fuentes originales frente a las transcripciones modernas. Además, hay una gran cantidad de métodos y libros a nuestro alcance. Esto en parte es debido al fácil acceso que nos permite internet.==
...
- Gerardo Arriaga recomienda hacer dos versiones de la transcripción:
...
[^10]: Boyd; Carreras, *La música en España en el siglo XVIII*.

[^11]: Iborra, *La guitarra: Historia, organología y repertorio*.

[^13]: Ophee, *Una breve historia de los métodos de guitarra*.

[^3]: Pajares Alonso, *Historia de la música en seis bloques*.

[^4]: Radole, *Laúd, guitarra y vihuela*.

[^10]: Santa María, *Arte de tañer fantasía*.