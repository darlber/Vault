...
1. [Repertorio de guitarra renacentista](#Repertorio%20de%20guitarra%20renacentista)
	...
	3. [Repertorio](#Repertorio)
2. [Estilo y notación](#Estilo%20y%20notación)
	1. [Lectura](#Lectura)
...
- No se conserva ninguna guitarra medieval, y la información es escasa y a veces contradictoria. Pajares[^Pajares Alonso[^1]] Alonso sitúa la guitarra en el contexto más amplio de la historia de la música, mientras que Radole[^Radole[^2]] ofrece una visión general del laúd, la guitarra y la vihuela como instrumentos de la misma familia.

- El **inicio documentado** de la guitarra renacentista es en **1546**, con la publicación en Sevilla de:
  - *Tres libros de música en cifra para vihuela* de **Alonso Mudarra[^Mudarra[^3]]**
  - Contiene las **primeras 6 piezas para guitarra de 4 órdenes**:
    - 4 fantasías
    - 1 pavana
    - 1 romanesca

- A finales del siglo XVI, la guitarra evoluciona a **5 órdenes**, lo que da origen a la **guitarra barroca española**, con **Juan Carlos Amat[^Amat[^4]]** (1596).

- **Ambos tipos (renacentista y barroca) coexistieron** durante un tiempo.

- La historia de la guitarra en este período ha sido documentada por Boyd[^Boyd y Carreras[^5]] y Carreras e Iborra[^Iborra[^6]], quienes analizan la evolución social y organológica del instrumento.

- Cambios principales:
  - **Número de órdenes**: de 4 a 5
  - **Técnica**:
    - Guitarra renacentista: punteado
    - Guitarra barroca: aparición del **estilo rasgueado**
...
- Durante el **primer tercio del siglo XVII**, muchos libros enseñaban acompañamiento rasgueado básico.
	- Con **Giovanni Paolo Foscarini[^Foscarini[^7]]** se inicia la **combinación de punteado y rasgueado**.
- Durante los **siglos XVII y XVIII**, la **guitarra de cinco órdenes** alcanzó gran desarrollo:
  - Se publicaron **más de 150 libros** impresos para este instrumento, según documenta Ophee[^Ophee[^8]] en su estudio sobre los métodos de guitarra.
...
- El primer documento con música para esta nueva guitarra es de **Juan Antonio Vargas[^Vargas y Guzmán[^9]] y Guzmán**, fechado en **Cádiz (1773)**:
...
- **Antecedente importante**: el tratado de **Andrés Sotos[^Sotos[^10]] (1764)**, *Arte para aprender con facilidad y sin maestro...*:
  - Describe guitarras de **4, 5 y 6 órdenes**, además de otros instrumentos como **bandurria, vandola y tiple**.
  - El tratado es básicamente una **copia del método de J.C. Amat[^Amat[^4]]**.
  - Indica que ya en 1764 existía **vacilación entre órdenes dobles y cuerdas simples**.

- **Fernando Moretti[^Moretti[^11]]**, guitarrista italiano, tuvo gran influencia:
  ...
  - En **1799**, publica en castellano *Principios para tocar la guitarra de seis órdenes*:
    ...
    - Centrado en la guitarra **de seis órdenes dobles**, la más popular en España en ese momento.
...
- En **1799**, además de Fernando Moretti[^Moretti[^11]], **otros autores publicaron métodos** para la nueva guitarra de seis órdenes:
  - Destaca **Fernando Ferandiere[^Ferandiere[^12]]**, quien publica en Madrid *Arte para tocar la guitarra española*.
...
## Afinación
- Según el tratado *Libro de la declaración de instrumentos* (1555) de **Juan Bermudo[^Bermudo[^13]]**:
  ...
  - La mayoría de las obras estaban compuestas para **temple nuevo**.
    - El propio Bermudo[^Bermudo[^13]] señala que el temple viejo solo se usaba para **romances antiguos**, no para la música de su época.
## Repertorio
...
- **Únicamente dos publicaciones** dedicadas a la guitarra renacentista de **cuatro órdenes**:
  1. **1546** – *Tres libros de música en cifra para vihuela* (Alonso Mudarra[^Mudarra[^3]]):
  ...
  2. **1554** – *Orphenica Lira* (Miguel de Fuenllana[^Fuenllana[^14]]):
...
- País más prolífico en cuanto a repertorio para guitarra renacentista.
  ...
  - Autores destacados:
    - **Guillaume de Morlaye[^Morlaye[^15]]**
    - **Simon Gorlier[^Gorlier[^16]]**
    - **Grégoire Brayssing[^Brayssing[^17]]** (alemán)
    - **Adrian le Roy[^Le Roy[^18]]**: el más influyente.
      - Fue un excelente laudista y editor.
      - Junto a **Robert Ballard**, fundó la editorial **Le Roy[^Le Roy[^18]]-Ballard**, una de las más importantes del siglo XVI.
- El repertorio de guitarra renacentista francés, aunque **más ligero y sencillo** que las fantasías españolas para vihuela o los ricercares italianos para laúd, era **muy popular entre aficionados**.
  - Esto se debe a que el público al que iba dirigido era **amateur**, no profesional.
...
- En los **Países Bajos**, también apareció repertorio para guitarra:
  ...
  - Destacan los editores **Pierre Phalese[^Phalese[^19]]** y **Jean Bellere**, quienes publicaron antologías con repertorio francés adaptado a la **tablatura latina**.

#### Colecciones conservadas (total: 13 colecciones, 351 piezas)

1. Alonso Mudarra[^Mudarra[^3]] – *Tres libros de música en cifra para vihuela* (Sevilla, 1546)
2. Melchiore de Barberiis[^Barberiis[^20]] – *Opera intitolata Confina* (Venecia, 1549)
3. Simon Gorlier[^Gorlier[^16]] – *Le troysieme livre... de guitente* (París, 1551)
4. Adrian le Roy[^Le Roy[^18]] – *Premier livre de tabulature de guiterre* (París, 1551)
5. Adrian le Roy[^Le Roy[^18]] – *Tiers livre de tabulature de guiterre* (París, 1552)
6. Guillaume Morlaye[^Morlaye[^15]] – *Le premier livre... de guitente* (París, 1552)
7. Guillaume Morlaye[^Morlaye[^15]] – *Quatruiesme livre... de guyterne* (París, 1552)
8. Gregoire Brayssing[^Brayssing[^17]] – *Quan livre de tabulature de guiterre* (París, 1553)
9. Guillaume Morlaye[^Morlaye[^15]] – *Le second livre... de guiterre* (París, 1553)
10. Miguel de Fuenllana[^Fuenllana[^14]] – *Libro de música para vihuela intitulado Orphenica Lyra* (Sevilla, 1554)
11. Adrian le Roy[^Le Roy[^18]] – *Cinquiesme livre de guiterre* (París, 1554)
12. Adrian le Roy[^Le Roy[^18]] – *Second livre de guiterre* (París, 1556)
13. Pierre Phalese[^Phalese[^19]] y Jean Bellere – *Selectissima elegantissimaque...* (Lovaina y Amberes, 1570)
...
==El estilo de la guitarra renacentista se distingue del de la vihuela por su **textura predominantemente homofónica**, que Reese[^Reese[^21]] sitúa como característica general de la música del Renacimiento, y su carácter más **ligero y accesible**, orientado a un público amateur. Frente a la densidad contrapuntística de las fantasías de Milán o Narváez, la guitarra de cuatro órdenes cultivó un repertorio de **danzas** (pavanas, gallardas, romanescas) y **canciones con acompañamiento**, donde la melodía se sitúa en la voz superior y las cuerdas graves proporcionan el soporte armónico. Esta textura, más vertical que horizontal, anticipa ya el lenguaje armónico de la guitarra barroca.==

==Las **formas musicales** más cultivadas fueron la **fantasía** —de carácter más libre que la vihuelística, con menor rigor imitativo—, las **danzas** (pavana, gallarda, romanesca, villancico) y las **intabulaciones** de música vocal polifónica. La fantasía española (Mudarra[^Mudarra[^3]], Fuenllana[^Fuenllana[^14]]) conserva cierto aliento contrapuntístico, mientras que la francesa (Le Roy[^Le Roy[^18]], Morlaye[^Morlaye[^15]]) es más breve y homofónica, pensada para el disfrute del aficionado. Las diferencias —técnica de variación sobre un tema—, aunque propias de la vihuela, también se cultivaron en la guitarra, como muestra la romanesca *Guárdame las vacas* de Mudarra[^Mudarra[^3]]. La notación de este repertorio ha sido estudiada por Apel[^Apel[^22]] en su obra sobre la notación musical polifónica.==

==La **ornamentación** en la guitarra renacentista sigue las mismas prácticas que la vihuela, aunque de forma más moderada. Las fuentes mencionan **glosas**, **redobles** y **trinos**, especialmente en cadencias y pasajes de reposo. Al igual que en la vihuela, las indicaciones escritas son escasas y la ornamentación se dejaba en gran medida al criterio del intérprete. Juan Bermudo[^Bermudo[^13]], en su *Declaración de instrumentos musicales* (1555), documenta las prácticas ornamentales del momento, mientras que los tratados de Diego Ortiz[^Ortiz[^23]] (1553) y Tomás de Santa María[^Santa María[^24]] (1565) ofrecen modelos de cómo glosar pasajes, aplicables también a la guitarra, siguiendo las prácticas ornamentales que Brown[^Brown[^25]] documenta en el siglo XVI.==

==**Diferencias entre escuelas nacionales:** Lowinsky[^Lowinsky[^26]] señala que la diversidad estilística del siglo XVI responde a distintas concepciones tonales y estéticas. La escuela **francesa** (Le Roy[^Le Roy[^18]], Morlaye[^Morlaye[^15]], Gorlier[^Gorlier[^16]], Brayssing[^Brayssing[^17]]) es la más prolífica y su estilo es el más ligero, con predominio de danzas y canciones sobre fantasías contrapuntísticas. Su público era mayoritariamente amateur. La escuela **española** (Mudarra[^Mudarra[^3]], Fuenllana[^Fuenllana[^14]]) es más seria y contrapuntística, heredera directa de la tradición vihuelística, con un menor número de obras pero de mayor densidad polifónica. La escuela **italiana** (Barberis) ocupa una posición intermedia, con fantasías que combinan elementos imitativos con secciones danzables. Esta diversidad nacional refleja contextos sociales diferentes: la guitarra francesa se difunde en círculos burgueses urbanos, mientras que la española permanece ligada a la corte y al humanismo aristocrático.==

==La **evolución estilística** hacia finales del siglo XVI viene marcada por la transición de la guitarra de **cuatro a cinco órdenes** y la aparición del **estilo rasgueado** (J. C. Amat[^Amat[^4]], 1596). Este cambio no solo amplía las posibilidades armónicas del instrumento, sino que transforma su estética: los acordes se conciben ahora como entidades verticales y la técnica de rasgueado introduce un nuevo ideal sonoro, más percusivo y rítmico, que preludia la guitarra barroca. La combinación de **punteado y rasgueado** —sistematizada por Foscarini[^Foscarini[^7]] en el siglo XVII— se convertirá en el rasgo definitorio del estilo guitarristico del Barroco.==
...
- **Tablatura italiana** (usada en guitarra de cuatro órdenes):
  ...
  - Sobre las líneas se indican los trastes a pisar con los siguientes símbolos:
    - 0 = al aire
    - 1 = traste uno
    - 2 = traste dos
    - 3 = traste tres
...
==Sobre la lectura debemos decir que lo recomendable es que el intérprete no utilice ningún tipo de transcripción, ya que hoy en día tenemos los facsímiles y además no es complicado leer una tablatura antigua. Esto ya lo defienden J. Tyler[^Tyler[^27]] y G. Arriaga[^Arriaga[^28]], y el propio Turnbull[^Turnbull[^29]] aboga por el uso de fuentes originales frente a las transcripciones modernas. Además, hay una gran cantidad de métodos y libros a nuestro alcance. Esto en parte es debido al fácil acceso que nos permite internet.==
...
- La afinación debe cumplir dos características:
  1. Ser cómoda para la lectura del intérprete.
  2. Respetar el sistema teórico renacentista.

- Alcanzar ambos objetivos simultáneamente es muy difícil.
- Gerardo Arriaga[^Arriaga[^28]] recomienda hacer dos versiones de la transcripción:
  - Una versión fácil de leer, en Re (usando las cuatro primeras cuerdas de la guitarra) y una clave.
  - Otra versión estricta, con una o dos claves y afinación aguda acorde al modo de la pieza.

- Además, para acercarse a la perfección, se aconseja aportar:
...
[^15]: Morlaye, *Le premier livre de guitente*

[^16]: Gorlier, *Le troysieme livre de guitente*

[^17]: Brayssing, *Quan livre de tabulature de guiterre*

[^18]: Le Roy; Ballard, *Livres de Guiterre*

[^19]: Phalese; Bellere, *Selectissima elegantissimaque*

[^20]: Barberiis, *Opera intitolata Contina*
