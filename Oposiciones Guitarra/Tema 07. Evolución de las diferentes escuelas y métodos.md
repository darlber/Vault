...
1. [Evolución de las diferentes escuelas y sus métodos, así como concepciones estéticas, teóricas y técnicas](#Evolución%20de%20las%20diferentes%20escuelas%20y%20sus%20métodos,%20así%20como%20concepciones%20estéticas,%20teóricas%20y%20técnicas)
	...
	2. [Evolución de las diferentes escuelas](#Evolución%20de%20las%20diferentes%20escuelas)
2. [Bibliografía](#Bibliografía)
# Evolución de las diferentes escuelas y sus métodos, así como concepciones estéticas, teóricas y técnicas
## Introducción
Desde la época del Renacimiento, particularmente con los laudistas y vihuelistas, ya existía una clara preocupación por la interpretación musical, la ejecución técnica y su enseñanza. Estos músicos comenzaron a escribir tratados que abordaban temas como la técnica de pulsación, la postura con el instrumento, la colocación de las manos, la ejecución de pasajes complejos y la ornamentación.

Aunque la producción de estos tratados se remonta al siglo XVI, fue entre finales del siglo XVIII y principios del XIX cuando surgió un interés más generalizado por publicar métodos didácticos. Estos textos no solo se enfocaban en la técnica, sino que también demostraban enfoques pedagógicos tan claros y modernos que sorprenden por el periodo en el que fueron escritos.
...
- **2 dúos**
- **1 motete**
- Varios **contrapuntos** sobre melodías seculares e himnos

Distribución instrumental:
- **160** para vihuela de seis órdenes  
...
**Escuela laudística**: Durante el Renacimiento y el primer Barroco, muchos laudistas publicaron tratados que reflejan una notable evolución técnica y un pensamiento teórico sorprendentemente avanzado, en ocasiones comparable con teorías de los siglos XIX y XX. Se tratan temas como:

- Técnicas de pulsación (figueta extranjera y castellana)
- Arpegio de acordes
- Toque de yema
...
Estos tratados se centraban principalmente en aspectos técnicos de la **mano izquierda** y **mano derecha**, y abordaban temas como:
...
- Ligados  
- Decoraciones y ornamentaciones  
- Uso específico de ciertos dedos para mejorar la articulación y la limpieza sonora  

Los tratados técnico-didácticos de la escuela laudística barroca abordaban con detalle aspectos de **técnica para ambas manos**. A continuación, se resumen los principales temas tratados:

**Mano derecha:**
- Pulsación con **(p, i)** (pulgar e índice), usando principalmente **(i, m)** (índice y medio) para la línea melódica
- El **pulgar** reservado para la ejecución de los **bajos**
- Posición más **perpendicular** de la mano y **apoyo del meñique** en la tapa del instrumento (inicialmente cerca del puente, luego más atrás)
- Funciones específicas de cada dedo y técnica de **tirado hacia dentro** de la mano
- Realización del **arpegio de acordes** con distintas combinaciones: (i), (p, i), (m), en dirección **ascendente o descendente**
- Uso combinado de **yema y uña** para lograr un sonido equilibrado en conjunto

**Mano izquierda:**
- **Libertad de desplazamiento** con acompañamiento del pulgar al índice
- **Extensión de la muñeca** y colocación del **pulgar a la mitad del mástil**
- Mantener los **dedos cerca de las cuerdas** y **fijos hasta el cambio de nota**
- Uso del **ligado técnico como articulación**

Algunas de las técnicas descritas en los tratados renacentistas y barrocos están tan adelantadas a su época que podrían formar parte de la escuela moderna. Con la llegada del **Barroco** y el desarrollo de la **guitarra española de cinco órdenes**, se produjo un gran avance técnico y musical del instrumento.

En comparación con la guitarra renacentista, la nueva guitarra era más grande y tenía más órdenes (hasta cinco), lo que permitió nuevas técnicas de ejecución:
- **Rasgueado**
- **Punteado**
- **Estilo mixto**
