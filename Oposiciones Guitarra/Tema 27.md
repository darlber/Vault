...
- En la última década se ha generalizado la práctica de la improvisación, que permite al intérprete desarrollar procesos creativos
- Composición e improvisación son semejantes y diferentes: ambas producen productos musicales nuevos, pero difieren en el carácter espontáneo de la improvisación frente al carácter «pensado y editado» de la composición tradicional
- La creatividad ha sido muy valorada en los procesos educativos por sus beneficios para la educación integral
- En los conservatorios, la creatividad estaba destinada casi exclusivamente a los estudios de Composición, a los que se accedía tras estudios elementales y medios
- La formación del intérprete incidía en el dominio técnico, la inserción en grupos instrumentales y el aprendizaje del código (teoría y solfeo tradicional)
- Las reformas educativas han introducido la creatividad y la improvisación en los currículos oficiales de enseñanzas musicales especializadas
...
- **Conectividad**: el ser humano no crea de la nada; la capacidad creadora obliga a establecer relaciones entre elementos existentes. La creatividad humana es relacional
- **Originalidad**: alude a novedad, impredictibilidad, sorpresa y unicidad
- **No racionalidad**: se ocupa de los procesos metafóricos y de simbolización; la metáfora posibilita visiones nuevas y perspectivas inesperadas
...
- Elementos negativos: autoritarismo, falta de flexibilidad, poca preocupación por el aprendizaje
...
- La aparición de nuevas metodologías (improvisación) abre nuevos caminos, pero se necesita un cambio más profundo
- La práctica instrumental debe ser una oportunidad para el desarrollo de la creatividad desde el primer momento
- Criterios generales:
  - Estimular al alumnado a conectarse directamente con su instrumento, evitando condicionantes externos como la técnica o la lectura
  - Superar la metodología tradicional de iniciación (notas largas, escalas, arpegios) que dejaba poco margen a la creatividad
  - Propiciar un contacto libre y sin prejuicios con el instrumento: exploración, canciones sencillas, improvisación y creación desde los primeros momentos
- Las audiciones y conciertos públicos son oportunidades para demostrar la individualidad y para el juego, el descubrimiento y la creatividad
- Es fundamental establecer un ambiente festivo, informal, desenfadado y relajado en las audiciones; alejar la repetición mecánica y la obsesión prematura por la perfección
- La interpretación musical actual tiene una visión holística: la técnica debe estar al servicio de la expresividad
- El dominio del cuerpo es el primer paso, pero el progreso técnico ha de ir en consonancia con las necesidades musicales
...
- Tres tipos de improvisación:
  - **Recreativa**: actividad placentera del músico aficionado
  - **Profesional**: actividad especializada (jazz, música pop, etc.)
  - **Educativa**: técnica didáctica aplicada en distintos niveles del proceso de enseñanza-aprendizaje
- La improvisación educativa es la de mayor interés didáctico y metodológico
- Su presencia en los conservatorios ha aumentado gracias a la valorización del jazz, el reconocimiento del papel histórico de la improvisación y sus beneficios pedagógicos
- La improvisación promueve:
  - Procesos de carácter expresivo y comunicativo
  - Procesos centrados en la adquisición y relación de materiales y conceptos del lenguaje musical
- Responde a:
...
La competencia «sentido de la iniciativa y espíritu emprendedor» implica las habilidades para convertir ideas en actos: creatividad, capacidad de asumir riesgos, planificar y gestionar proyectos. Pretende que el alumnado:
- Tome decisiones con criterio y desarrolle la opción elegida asumiendo consecuencias
- Adquiera habilidades personales: autonomía, creatividad, autoestima, autocrítica, iniciativa, control emocional
- Afronte soluciones distintas ante nuevos contextos

### Legislación

- **Ley 14/2013**, de 27 de septiembre, de apoyo a los emprendedores y su internacionalización
  - Art. 3: define al emprendedor como persona que desarrolla una actividad económica o profesional
  - Art. 4: dedicado al emprendimiento en enseñanza primaria y secundaria
  - Art. 5: dedicado al emprendimiento en enseñanzas universitarias
  - Encomienda al Estado la incorporación en los currículos de objetivos, competencias, contenidos y criterios de evaluación orientados al espíritu emprendedor
  - Encomienda a las Administraciones educativas el fomento de la participación del alumnado en actividades que afiancen el espíritu emprendedor (creatividad, iniciativa, trabajo en equipo, confianza, sentido crítico)
  - Incluye la formación del profesorado en materia de emprendimiento
- **LOMCE**, preámbulo: define el emprendimiento como competencia clave para mejorar la empleabilidad
  - Art. 17 b): desarrollar hábitos de trabajo individual y de equipo, esfuerzo, responsabilidad, confianza, sentido crítico, iniciativa, curiosidad, creatividad y espíritu emprendedor
  - Art. 18.6: el emprendimiento se trabajará en todas las áreas

### Cualidades, habilidades, actitudes y valores

Según los materiales del Ministerio de Educación, Cultura y Deporte, se distinguen tres ámbitos:

**Saber:**
- Comprensión del funcionamiento de las sociedades y organizaciones
- Diseño e implementación de un plan
- Conocimiento de oportunidades para actividades personales, profesionales y comerciales

**Saber hacer:**
- Capacidad de análisis, organización, planificación y gestión
...
- **Innovación**: iniciar acciones nuevas, creatividad, generación de cambio, planificación de proyectos, visión de futuro
- **Habilidades empresariales**: definición del objeto de negocio, gestión económico-financiera, gestión de recursos humanos, marketing, responsabilidad social y sentido ético
...
- En la educación tradicional, las clases de instrumento formaban exclusivamente intérpretes capacitados para la reproducción de partituras
